<?php
    ...
    // PAGINATION
    $dataPerPage = 10;
    $totalData = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pos"));
...
<body>
    ...
    <!-- FORM CONTENT -->
            <div class="flex flex-grow">
                <div class="mt-5 ml-72 mx-auto w-3/6">
                    <div class="flex">
                            <a 
                                href="pos-tambah.php"
                                type="submit"
                        ...
                        <tbody>
                            ...
                            <tr class="bg-gray-100 border-b hover:bg-gray-300 w-full">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <a href="pos-ubah.php?idstore=<?php echo $data['idstore'];?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" onclick="return confirm('Konfirmasi hapus data')">Delete</a>
                                </td>
                            </tr>
                            <?php 
                                }
