            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input
                            id="username"
                            value="<?php echo $data['idproduk'];?>" readonly
                            name="idproduk"
                            type="text"
                            required
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input
                            id="username"
                            name="hargaproduk"
                            value="<?php echo $data['hargaproduk'];?>"
                            type="text"
                            required
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-400 sm:text-sm sm:leading-6 p-2"
                        />
...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "UPDATE produk SET namaproduk='$namaproduk', hargaproduk='$hargaproduk' WHERE idproduk='$idproduk'");
